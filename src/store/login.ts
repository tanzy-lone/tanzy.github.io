...
const loginStore = defineStore('loginStore', {
	...
	actions: {
		async loginAction(payload: any) {
			...
			const arr1 = [
				{ id: 888, name: 'home', type: 2, url: '/main/home/index', sort: 111, children: [] },
				{ id: 999, name: 'dashbard', type: 2, url: '/main/dashbard/index', sort: 222, children: [] }
			]
			const iconUrl = reactive([
				'icon-home',
				'icon-dashboard_dashbord_icon',
				'icon-manage',
				'icon-systerm',
				'icon-shoping',
				'icon-dingtalk',
